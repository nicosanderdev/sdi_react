-- Migration: Update get_dashboard_summary totalProperties metric
-- to count published properties (visible and active).
...
BEGIN
    ...
    */
    ...
    -- Get total published properties (visible and active)
