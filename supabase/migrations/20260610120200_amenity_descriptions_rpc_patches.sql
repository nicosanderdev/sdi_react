...
-- Prerequisite: 20260610120000_estate_property_amenity_localized_descriptions.sql (schema + helpers + create_estate_property).
-- Manual apply by project owner (idempotent where possible).

begin;

-- ---------------------------------------------------------------------------
-- 1) update_estate_property — replace stub; persist p_amenity_links (dashboard edit)
--    Signature aligned with PropertyService.updateProperty RPC call.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2) get_public_event_venue_property_by_id — add Amenities jsonb payload
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3) get_public_summer_rent_property_by_id — add Amenities jsonb payload
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4) duplicate_estate_property — copy LocalizedDescriptions (body from public_schema dump)
-- ---------------------------------------------------------------------------
