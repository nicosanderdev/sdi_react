...
export function LoginPage() {
  ...
  // When a redirect is pending (after login or already logged in), confirm session and navigate.
  // Use Supabase getSession() so we don't depend on AuthContext update timing.
  useEffect(() => {
